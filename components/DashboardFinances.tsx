...
export const DashboardFinances: React.FC<DashboardFinancesProps> = ({ leads }) => {
    ...
    return (
        ...
        <div className="flex flex-col xl:flex-row h-full overflow-hidden">
            ...
            <div className="w-full xl:w-[40%] flex flex-col gap-6 overflow-y-auto custom-scrollbar p-2">
                <h2 className="text-lg font-semibold text-zinc-100 flex items-center gap-2 sticky top-0 bg-[#050505] z-10 py-2">
            ...
            <div className="w-full xl:w-[60%] flex flex-col gap-6 overflow-y-auto custom-scrollbar p-2">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sticky top-0 bg-[#050505] z-10 py-2">
